$(function () {
  ...
  function setup() {
    ...
    createPlatform(650, 360, 105, 5, "rgb(229, 102, 6");
    createPlatform(950, 360, 105, 5, "rgb(229, 102, 6");
    createPlatform(1250, 360, 105, 5, "rgb(229, 102, 6");
    ...
    createCollectable("diamond", 1300, 250, .25, 1);
